...
// 1. Remove useRazorpay import (handle both \r\n and \n)
content = content.replace(/import { useRazorpay } from "@\/hooks\/useRazorpay";\r?\n/, '');
...
content = content.replace(/ *const { initiatePayment } = useRazorpay\(\);\r?\n/, '');
